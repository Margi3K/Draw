...
// 80 is the 'p' key
function keyPressed() {
  if (keyCode == 80) playMode = !playMode;
}
...
function paddleCollisions() {
  ...
  if (
    ...
    // increases the speed after 4 or 10 paddle collisions during each round
    if (paddleCollisionsCount == 4 || paddleCollisionsCount == 10) {
      changeSpeed = true;
    }
    ...
    // increases the speed after 3 paddle collisions during each round
    if (paddleCollisionsCount % 3 === 0) {
      changeSpeed = true;
    }
  }
...
function playerScores() {
  ...
  fill(255);
  textSize(50);
  text(p1Score, width * 0.15, height * 0.1);
  text(p2Score, width * 0.83, height * 0.1);
